...
def _get_project_root() -> str:
    """Get ignis_router project root (3 levels up from this file)."""
    return str(Path(__file__).resolve().parents[3])


def _get_package_root() -> str:
    """Get ignis_router package root (1 level up from this file)."""
...
class MLInferenceEngine:
    ...
    def __init__(
        ...
        self._package_root = _get_package_root()
        self._config_dir = os.path.join(self._package_root, config_dir)
    ...
    def _ensure_model_file(self, llmrouter_root: str) -> None:
        ...
        local_model = os.path.join(self._package_root, "models", subdir, filename)
...
class TrainingPipeline:
    ...
    def train(self, router_type: str) -> bool:
        ...
        yaml_path = os.path.join(
            self._package_root, "configs", "ml_routers",
            {"knn": "knnrouter.yaml", "svm": "svmrouter.yaml",
    ...
    def _copy_trained_model(self, router_type: str, llmrouter_root: str) -> None:
        ...
        dst_dir = os.path.join(self._package_root, "models", subdir)
